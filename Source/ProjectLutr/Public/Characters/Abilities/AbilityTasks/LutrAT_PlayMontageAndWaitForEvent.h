...
#include "LutrAT_PlayMontageAndWaitForEvent.generated.h"

class ULutrAbilitySystemComponent;
 ...
 */
UCLASS()
class PROJECTLUTR_API ULutrAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	ULutrAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static ULutrAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
