 ...
 */
UCLASS()
class PROJECTLUTR_API UFPSCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
	
	class FFPSSavedMove : public FSavedMove_Character
	{
	public:
	...
	class FFPSNetworkPredictionData_Client : public FNetworkPredictionData_Client_Character
	{
	public:
		FFPSNetworkPredictionData_Client(const UCharacterMovementComponent& ClientMovement);
