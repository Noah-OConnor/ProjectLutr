...
#include "LutrCharacterMovementComponent.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTLUTR_API ULutrCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	ULutrCharacterMovementComponent();
